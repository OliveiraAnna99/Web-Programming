...
@section('title', __('tarefa.create'))

@section('content')
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">{{ __('tarefa.create') }}</div>
            <form method="POST" action="{{ route('tarefas.store') }}" accept-charset="UTF-8">
                {{ csrf_field() }}
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('tarefas.index') }}" class="btn btn-link">{{ __('app.cancel') }}</a>
                </div>
            </form>
        </div>
    </div>
